...
6. Локальное хранение избранного (CoreData)
7. Кэширование изображений в памяти (NSCache)
8. Отображение ошибок загрузки
...
- FavoritesStore управляет сохранением избранных изображений (CoreData)
- ImageLoader кэширует изображения и отвечает за загрузку
